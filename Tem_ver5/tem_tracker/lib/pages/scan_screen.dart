...
import 'bluetooth/package2.dart';
...
showCurrentDate(BuildContext context) {
  ...
  Scaffold.of(context).showSnackBar(SnackBar(
    content:
        Text(AppLocalizations.of(context).translate('import_staff_data_button')
//        "測量時間："
            +
            currentDate +
            " " +
      ...
      new Padding(
          ...
          child: new Column(
            children: <Widget>[
              Center(
                child: Text(
                  AppLocalizations.of(context).translate('tem_last_measure'),
...
//                '上次量測時間',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).translate('tem_measure')
//            "體溫量測"
            ),
        centerTitle: true,
...
//                  showCurrentDate(context);
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            FlutterBlueApp()), //FindDevicesScreen
                  );
                },
...
class BluetoothOffScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            AppLocalizations.of(context).translate('alertDialog_tem_measure')
//            "量測結果"
            ),
        ...
        actions: <Widget>[
          IconButton(
            ...
            tooltip: AppLocalizations.of(context).translate('toast_rescan')
//            '重新掃描'
            ,
            onPressed: () =>
                FlutterBlue.instance.startScan(timeout: Duration(seconds: 5)),
