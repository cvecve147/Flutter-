                        ...
                        if (num != '0') {
                          ...
                          return showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  title: Text(AppLocalizations.of(context)
                                      .translate('alertDialog_person_pairing')//'未配對成功'
                                  ),
                                  content: SingleChildScrollView(
                                    child: ListBody(
                                      children: <Widget>[
                                        Text(AppLocalizations.of(context)
                                            .translate('alertDialog_not_paired_yet')//"還並未配對"
                                        ),
                                      ],
                                    ),
                                  ),
                            ...
                            if (result == "請檢查資料") {
                              return showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    title: Text(AppLocalizations.of(context)
                                        .translate('alertDialog_pairing_failed')//'配對失敗'
                                    ),
                                    content: SingleChildScrollView(
                                      child: ListBody(
                                        children: <Widget>[
                                          Text(AppLocalizations.of(context)
                                              .translate('toast_repeat_tag')//"人員編號重複，請重新新增"
                                          ),
                                        ],
                                      ),
                                    ),
