...
class ScanResultTile extends StatelessWidget {
  ...
  Widget getTempWidgets(
      List<String> nameL, List<String> tempL, List<String> numberL) {
...
//    res.add('${trans(data[1])}');
  ...
  Future<void> searchData(
      List<String> nameL, List<String> tempL, List<String> numberL) async {
    sqlhelper sqlhepler = new sqlhelper();
    List a = await sqlhepler.showEmployee();
    return a;
  }

  Future<void> insertData(List<String> nameL, List<String> tempL,
      List<String> numberL, int i) async {
    sqlhelper sqlhepler = new sqlhelper();
    var a = await sqlhepler.searchEmployeeMAC(nameL[i]);
    temperature data = new temperature(
        id: a[0].id, temp: tempL[i], time: "2020-01-23 19:00:00");
...
//              ),
          ...
          secondaryActions: <Widget>[
            IconSlideAction(
              ...
              color: Color(0xFF81E9E6),
              icon: Icons.check_circle,
              onTap: () => createConfirmPairAlertDialog(
